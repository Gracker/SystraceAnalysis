...
class GPU(FTraceComponent):
    ...
    def pwrstate_intervals(self, device=None, state=None, interval=None):
        ...
        """
        try:
            list(self._pwrstate_intervals_by_device.keys())
        ...
        try:
            if device is not None:
                ...
                intervals = IntervalList(
                                sorted_items(
                                    list(self._pwrstate_intervals_by_device.values())))
    ...
    def buslevel_intervals(self, device=None, interval=None):
        ...
        """
        try:
            list(self._buslevel_intervals_by_device.keys())
        except AttributeError:
        ...
        try:
            if device is not None:
                ...
                intervals = IntervalList(
                                sorted_items(
                                    list(self._buslevel_intervals_by_device.values())))
    ...
    def frequency_intervals(self, device=None, interval=None):
        ...
        try:
            list(self._pwrlevel_intervals_by_device.keys())
        except AttributeError:
        ...
        try:
            if device is not None:
                ...
                intervals = IntervalList(
                                sorted_items(
                                    list(self._pwrlevel_intervals_by_device.values())))
