...
def sim_busy_all_clusters(trace):
    ...
    return Series(data=list(data.values()), index=list(data.keys()), name=trace.filename) / total_duration
...
if __name__ == '__main__':
    ...
    df_lpm = DataFrame( index=ALL_CPUS, columns= list(LPM_states.values()))
